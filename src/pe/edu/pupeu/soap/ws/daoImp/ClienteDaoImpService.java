 ...
 * 
 */
@WebServiceClient(name = "ClienteDaoImpService", targetNamespace = "http://daoImp.ws.soap.pupeu.edu.pe/", wsdlLocation = "http://localhost:3030/soap/cliente?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CLIENTEDAOIMPSERVICE_QNAME = new QName("http://daoImp.ws.soap.pupeu.edu.pe/", "ClienteDaoImpService");
    ...
    public ClienteDao getClienteDaoImpPort() {
        return super.getPort(new QName("http://daoImp.ws.soap.pupeu.edu.pe/", "ClienteDaoImpPort"), ClienteDao.class);
    }
    ...
    public ClienteDao getClienteDaoImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://daoImp.ws.soap.pupeu.edu.pe/", "ClienteDaoImpPort"), ClienteDao.class, features);
    }
